...
(function () {
  ...
  const CARDS = [
    `<div class="mc"><h5>Most Visited Guides</h5><svg class="mini-svg" viewBox="0 0 120 50" preserveAspectRatio="none">
       <path d="M0 40 C20 20 35 30 55 18 S95 10 120 22 L120 50 L0 50 Z" style="fill:rgba(var(--brand-rgb),.18)"/>
       <path d="M0 40 C20 20 35 30 55 18 S95 10 120 22" fill="none" style="stroke:var(--primary)" stroke-width="2"/></svg></div>`,
    ...
    `<div class="mc"><h5>Most Visited pages trend</h5><svg class="mini-svg" viewBox="0 0 120 50" preserveAspectRatio="none">
       <path d="M0 30 L18 22 L34 34 L52 18 L70 26 L88 12 L106 24 L120 16" fill="none" style="stroke:var(--accent-violet)" stroke-width="2"/></svg></div>`,
    ...
    `<div class="mc"><h5>Deployments</h5><div class="mini-bars">
       <span style="height:30%;background:var(--accent-violet)"></span><span style="height:70%;background:var(--accent-violet)"></span>
       <span style="height:45%;background:var(--accent-violet)"></span><span style="height:85%;background:var(--accent-violet)"></span>
       <span style="height:60%;background:var(--accent-violet)"></span></div></div>`,
